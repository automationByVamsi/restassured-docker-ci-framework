...
public abstract class BaseApi {
    ...
    protected BaseApi()
    {
        ...
        var httpConfig = HttpClientConfig.httpClientConfig()
                .setParam("http.connection.timeout", PropertyUtil.getConfig().connectionTimeout())
                .setParam("http.socket.timeout",PropertyUtil.getConfig().socketTimeout());
    ...
    public BaseApi logAllRequestDetails()
    {
    ...
    public BaseApi logSpecificRequestDetails(LogDetail logDetail)
    {
        this.requestSpecification.filter(new RequestLoggingFilter(logDetail));
        return this;
    }

    public BaseApi logAllResponseDetails()
    {
    ...
    public BaseApi logSpecificResponseDetails(LogDetail logDetail)
    {
    ...
    public void setPathParam(String paramName, Object param)
    {
        this.requestSpecification.pathParam(paramName, param);
    }
